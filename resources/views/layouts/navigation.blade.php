<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed z-30 w-full">
    <!-- Primary Navigation Menu -->
    <div class="mx-auto px-4 sm:px-3 lg:px-6">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="text-xl font-bold pl-2 text-gray-800 dark:text-gray-200">TeleDoc</span>
                    </a>
                </div>
            </div>
            ...
            <div class="hidden lg:flex sm:items-center sm:ml-6">
                <div class="pr-2 inline-flex">
                    <button type="button" x-bind:class="darkMode ? 'bg-indigo-500' : 'bg-gray-200'" x-on:click="darkMode = !darkMode" class="pr-2 relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" role="switch" aria-checked="false">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden">
        <div class="p-3 pt-2 pb-3 mobile-menu">
            {!! $mobile_menu !!}
        </div>
